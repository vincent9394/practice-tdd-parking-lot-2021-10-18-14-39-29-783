...
class SmartParkingBoyTest {
    ...
    @Test
    //#1
    void should_return_ticket_when_execute_parkCar_given_car_and_two_same_capacity_parkingLot_and_smart_parking_boy() {
        //given
        Car car = new Car();
...
//    then
    ...
    @Test
        //#2
    void should_return_ticket_when_execute_parkCar_given_car_and_two_parkingLot_second_has_more_space_and_smart_parking_boy() {
        //given
        Car car = new Car();
...
//    then
    ...
    @Test
        //#3
    void should_return_two_car_when_execute_fetchCar_given_two_ticket_two_parkingLot_and_a_smart_parking_boy() {
        //given
        Car car1 = new Car();
        Car car2 = new Car();
        SmartParkingBoy parkingBoy = new SmartParkingBoy(Arrays.asList(new ParkingLot(8), new ParkingLot(10)));
    ...
    @Test
//4
    void should_return_error_msg_when_execute_parkCar_given_an_unrecognized_ticket_and_a_smart_parking_boy() {
        //given
    ...
    @Test
//5
    void should_return_error_msg_when_execute_fetch_car_given_an_used_ticket_two_parkingLots_and_a_smart_parking_boy() {
        //given
        SmartParkingBoy parkingBoy = new SmartParkingBoy(Arrays.asList(new ParkingLot(10), new ParkingLot(10)));
        Car car = new Car();
    ...
    @Test
//6
    void should_return_error_msg_when_execute_fetch_car_given_two_full_parkingLots_and_a_smart_parking_boy() {
        //given
